#!/usr/bin/env python3
"""
Script pour ajouter les colonnes méthode, mode_collecte_donnees et derniere_valeur_connue 
...
def main():
    ...
    script_path = Path(__file__).parent / "add_fields_to_indicateur_performance.sql"
    ...
    print("🔄 Exécution de la migration pour ajouter les colonnes à indicateur_performance...")
    ...
    try:
        ...
        print("   - methode")
        print("   - mode_collecte_donnees")
        print("   - derniere_valeur_connue")
        return 0
