...
from app.models.performance import StatutObjectif, PrioriteObjectif, TypeObjectif
...
class ReportGenerator:
    ...
    def generate_pdf_report(
        ...
        try:
            ...
            company_para = Paragraph(
                company_name.upper(),
                ParagraphStyle('CompanyName', fontSize=24, textColor=SECONDARY_COLOR,
            ...
            if system_settings.company_description:
                desc_para = Paragraph(
                    ...
                    ParagraphStyle('CompanyDesc', fontSize=10, textColor=colors.grey,
            ...
            info_style = ParagraphStyle('CoverInfo', fontSize=11, textColor=colors.HexColor('#1f2937'),
            ...
            if footer_parts:
                ...
                footer_para = Paragraph(
                    footer_text,
                    ParagraphStyle('Footer', fontSize=9, textColor=colors.white,
            ...
            if report_type in ['GLOBAL', 'OBJECTIFS']:
                ...
                story.extend(ReportGenerator._generate_objectifs_section(
                    ...
                    SECONDARY_COLOR, PRIMARY_COLOR, ACCENT_COLOR
                ))
            ...
            if period in ['CURRENT_MONTH', 'CURRENT_QUARTER', 'CURRENT_YEAR'] and report_type != 'SYNTHESE':
                story.extend(ReportGenerator._generate_comparative_section(
                    session, period, dates, report_type, title_style, heading_style, normal_style,
                    SECONDARY_COLOR, PRIMARY_COLOR, ACCENT_COLOR
                ))
            ...
            # ========================================
            if report_type != 'SYNTHESE':
                story.extend(ReportGenerator._generate_notes_section(
                    session, report_type, heading_style, normal_style,
                    SECONDARY_COLOR, PRIMARY_COLOR, ACCENT_COLOR
                ))
            ...
            # ========================================
            story.extend(ReportGenerator._generate_conclusion_section(
                session, dates, report_type, title_style, heading_style, normal_style,
                SECONDARY_COLOR, PRIMARY_COLOR, ACCENT_COLOR, system_settings
            ))
    ...
    def _generate_objectifs_section(
        ...
        story.append(Paragraph(
            ...
            ParagraphStyle('Bold', parent=normal_style, fontSize=11, textColor=colors.HexColor('#1f2937'), fontName='Helvetica-Bold')
        ))
        ...
        for statut, objs in objectifs_par_statut.items():
            ...
            if len(objs) > 5:
                statut_section.append(Paragraph(
    ...
    def _generate_comparative_section(
        ...
        story.append(Paragraph(intro_text, 
                              ParagraphStyle('Intro', parent=normal_style, fontSize=9,
                                           textColor=colors.HexColor('#6b7280'),
    ...
    def _generate_notes_section(
        ...
        title_para = Paragraph("NOTES ET OBSERVATIONS TERRAIN", 
                              ParagraphStyle('NoteTitle', fontSize=20, textColor=colors.white,
        ...
        if report_type in ['GLOBAL', 'OBJECTIFS'] and objectifs_avec_commentaires:
            ...
            for obj in objectifs_avec_commentaires:
                ...
                note_data = [
                    ...
                    [Paragraph(f"Statut: {statut} | Service: {obj.service_responsable or 'N/A'}", 
        ...
        if report_type in ['GLOBAL', 'INDICATEURS'] and indicateurs_avec_commentaires:
            ...
            for ind in indicateurs_avec_commentaires:
                note_data = [
                    ...
                    [Paragraph(f"Catégorie: {ind.categorie or 'N/A'} | Service: {ind.service_responsable or 'N/A'}", 
                             ParagraphStyle('Meta', parent=normal_style, fontSize=8, textColor=colors.grey))],
    ...
    def _generate_conclusion_section(
        ...
        if taux_real >= 80:
            ...
            appreciation = "La performance globale est <b>satisfaisante</b>, avec des marges de progression identifiées."
        else:
