...
from app.core.enums import FileType, FileStatus
...
class ExcelProcessorService:
    ...
    @classmethod
    def process_file(cls, file_path: str, file_type: str, metadata: dict) -> Tuple[bool, int, int, Optional[str], List[Dict]]:
        """
    ...
    @classmethod
    def _process_budget(cls, df: pd.DataFrame, metadata: dict) -> Tuple[bool, int, int, Optional[str], List[Dict]]:
        """
        ...
        try:
            ...
            error_msg = f"Erreur traitement budget: {str(e)}"
            logger.error(f"❌ {error_msg}")
            return False, 0, 0, error_msg, []
    
    @classmethod
    def _process_depenses(cls, df: pd.DataFrame, metadata: dict) -> Tuple[bool, int, int, Optional[str], List[Dict]]:
        """
        ...
        try:
            ...
            error_msg = f"Erreur traitement dépenses: {str(e)}"
            logger.error(f"❌ {error_msg}")
            return False, 0, 0, error_msg, []
    
    @classmethod
    def _process_revenus(cls, df: pd.DataFrame, metadata: dict) -> Tuple[bool, int, int, Optional[str], List[Dict]]:
    ...
    @classmethod
    def _process_personnel(cls, df: pd.DataFrame, metadata: dict) -> Tuple[bool, int, int, Optional[str], List[Dict]]:
    ...
    @classmethod
    def _process_rapport_activite(cls, df: pd.DataFrame, metadata: dict) -> Tuple[bool, int, int, Optional[str], List[Dict]]:
    ...
    @classmethod
    def _process_beneficiaires(cls, df: pd.DataFrame, metadata: dict) -> Tuple[bool, int, int, Optional[str], List[Dict]]:
    ...
    @classmethod
    def _process_indicateurs(cls, df: pd.DataFrame, metadata: dict) -> Tuple[bool, int, int, Optional[str], List[Dict]]:
    ...
    @classmethod
    def _process_generic(cls, df: pd.DataFrame, metadata: dict) -> Tuple[bool, int, int, Optional[str], List[Dict]]:
        """
        ...
        try:
            ...
            error_msg = f"Erreur traitement générique: {str(e)}"
            logger.error(f"❌ {error_msg}")
            return False, 0, 0, error_msg, []
    
    @classmethod
    def validate_file_structure(cls, file_path: str, file_type: str) -> Tuple[bool, Optional[str]]:
        """
