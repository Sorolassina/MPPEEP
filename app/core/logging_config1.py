...
# Force UTF-8 pour Windows (doit être fait AVANT toute sortie console)
if sys.platform == "win32":
    ...
    # Force UTF-8 pour l'environnement Python
...
def setup_logging() -> logging.Logger:
    ...
    # Les handlers utilisent maintenant sys.stdout/stderr directement
    # L'encodage UTF-8 a été configuré en début de fichier
