...
class PathConfig:
    ...
    def __init__(self):
        ...
        self.MOUNT_CONFIGS = {
            "static": {"path": "/static", "directory": str(self.STATIC_DIR), "name": "static"},
            "uploads": {"path": "/uploads", "directory": str(self.UPLOADS_DIR), "name": "uploads"},
            "media": {"path": "/media", "directory": str(self.MEDIA_DIR), "name": "media"},
        }
